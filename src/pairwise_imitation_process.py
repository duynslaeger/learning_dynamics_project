...
def moran_step(population_state, beta, mu, Z, h):
    ...
    fitness = pgg_game.fitness(p1.wealth, p1.strategy, population_state.population, Z, 6, 2.5, 0.625, 0.25, 0.0625, 0.3,
                               0.3), pgg_game.fitness(p2.wealth, p2.strategy, population_state.population, Z, 6, 2.5,
                                                      0.625, 0.25, 0.0625, 0.3, 0.3)
